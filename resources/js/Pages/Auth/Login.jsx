        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        Masuk ke sistem monitoring untuk melanjutkan
                    </p>
                </div>
            </div>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white dark:bg-slate-800 py-8 px-6 shadow-xl rounded-2xl border border-gray-200 dark:border-slate-700">
                    {status && (
                        <div className="mb-6 p-4 rounded-xl text-sm font-medium text-green-800 dark:text-green-200 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                            {status}
                        </div>
                    )}
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {canResetPassword && (
                                <div className="text-sm">
                                    <Link
                                        href="#"
                                        className="font-medium text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300 transition duration-200"
                                    >
                                        Lupa password?
                                    </Link>
                                </div>
